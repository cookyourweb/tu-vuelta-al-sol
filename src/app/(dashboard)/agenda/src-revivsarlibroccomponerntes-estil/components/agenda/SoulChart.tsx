  ...
  return (
    <div className={`print-page bg-background p-12 flex flex-col ${config.pattern}`}>
      ...
      <div className={`flex-1 max-w-2xl mx-auto w-full ${config.fontBody}`}>
        <p className="text-foreground/70 text-center mb-8 italic">
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className={`${config.highlightPrimary} rounded-lg p-4`}>
            ...
            <p className="text-sm text-foreground/70 mt-1">Casa 1 (identidad, presencia, yo)</p>
          ...
          <div className={`${config.highlightSecondary} rounded-lg p-4`}>
            ...
            <p className="text-sm text-foreground/70 mt-1">Casa 8 (emociones profundas, transformación)</p>
            <p className="text-sm text-foreground/80 mt-2">
          ...
          <div className={`${config.highlightAccent} rounded-lg p-4`}>
            ...
            <p className="text-sm text-foreground/70 mt-1">Casa 1 (forma de empezar, identidad visible)</p>
            <p className="text-sm text-foreground/80 mt-2">
          ...
          <div className={`${config.highlightPrimary} rounded-lg p-4`}>
            ...
            <p className="text-sm text-foreground/70 mt-1">Casa 1 (mente, comunicación)</p>
            <p className="text-sm text-foreground/80 mt-2">
        ...
        <div className={`${config.highlightSecondary} rounded-lg p-6`}>
          ...
          <div className={`space-y-2 text-foreground/80 ${config.fontBody}`}>
  ...
  return (
    <div className={`print-page bg-background p-12 flex flex-col ${config.pattern}`}>
      <div className="text-center mb-8">
        ...
        <p className={`text-foreground/60 mt-2 ${config.fontBody}`}>Nodo Norte</p>
        <div className={`${config.divider} w-16 mx-auto mt-4`} />
      </div>
      ...
      <div className={`flex-1 max-w-2xl mx-auto w-full space-y-6 ${config.fontBody}`}>
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className={`border-l-4 ${config.cardBorder} pl-6`}>
            ...
            <p className="text-foreground/80">"Cuando repito, ¿qué estoy buscando?"</p>
          ...
          <div className={`border-l-4 ${config.cardBorder} pl-6`}>
            ...
            <p className="text-foreground/80">"¿Qué parte de mí quiere evolucionar ahora?"</p>
            <div className={`h-16 border-b border-dashed ${config.iconSecondary} opacity-30 mt-4`} />
          </div>
        </div>
      </div>
