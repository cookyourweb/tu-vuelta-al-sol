...
export const styleConfigs: Record<AgendaStyle, StyleConfig> = {
  elegante: {
    ...
    calendarColors: {
      lunaNueva: 'bg-indigo-50 border-l-4 border-indigo-400',
      lunaLlena: 'bg-purple-50 border-l-4 border-purple-400',
      retornoSolar: 'bg-amber-50 border-l-4 border-amber-500',
      equinoccio: 'bg-yellow-50 border-l-4 border-yellow-500',
      eclipse: 'bg-slate-100 border-l-4 border-slate-500',
      retrogrado: 'bg-rose-50 border-l-4 border-rose-400',
    },
  },
  creativo: {
    name: 'Creativo',
    description: 'Vibrante y expresivo',
    fontDisplay: 'font-space-grotesk',
    fontBody: 'font-dm-sans',
    ...
    calendarColors: {
      lunaNueva: 'bg-violet-100 border-l-4 border-violet-500',
      lunaLlena: 'bg-fuchsia-100 border-l-4 border-fuchsia-500',
      retornoSolar: 'bg-orange-100 border-l-4 border-orange-500',
      equinoccio: 'bg-lime-100 border-l-4 border-lime-500',
      eclipse: 'bg-gray-200 border-l-4 border-gray-600',
      retrogrado: 'bg-pink-100 border-l-4 border-pink-500',
    },
  },
  minimalista: {
    name: 'Minimalista',
    ...
    pattern: '',
    calendarColors: {
      lunaNueva: 'bg-blue-50 border-l-2 border-blue-300',
      lunaLlena: 'bg-gray-100 border-l-2 border-gray-400',
      retornoSolar: 'bg-amber-50 border-l-2 border-amber-300',
      equinoccio: 'bg-green-50 border-l-2 border-green-300',
      eclipse: 'bg-gray-200 border-l-2 border-gray-500',
      retrogrado: 'bg-red-50 border-l-2 border-red-300',
    },
  },
  bohemio: {
    name: 'Bohemio',
    ...
    calendarColors: {
      lunaNueva: 'bg-sky-50 border-l-4 border-sky-400',
      lunaLlena: 'bg-pink-50 border-l-4 border-pink-400',
      retornoSolar: 'bg-orange-50 border-l-4 border-orange-500',
      equinoccio: 'bg-emerald-50 border-l-4 border-emerald-400',
      eclipse: 'bg-stone-100 border-l-4 border-stone-500',
      retrogrado: 'bg-red-50 border-l-4 border-red-400',
    },
  },
};
