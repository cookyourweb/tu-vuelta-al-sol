...
import { TuAnio2026Overview, TuAnio2026Ciclos, PaginaCumpleanos10Feb } from "./agenda/TuAnio2026Vero";
// Soul Chart
...
// NUEVO: Calendario Mensual Compacto
import { CalendarioEnero2026Completo } from "./agenda/CalendarioMensualCompacto";
// NUEVO: Semana Principal (diseño mejorado)
import { 
  SemanaPrincipal, 
  EjerciciosSemana,
  Semana1Enero, 
  ...
  Semana3Enero, 
  Semana4Enero,
  EjerciciosSemana1Enero,
  EjerciciosSemana2Enero,
  SemanaCumpleFebrero 
} from "./agenda/SemanaPrincipal";
// Propuestas calendario (solo para referencia visual)
import { PropuestaCalendario1 } from "./agenda/PropuestasCalendario";
// Ejemplo completo Enero 2026 (apertura e interpretaciones)
import { 
...
// Semanas antiguas (para referencia)
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div ref={printRef} className="container mx-auto py-8 space-y-0 print:p-0">
        ...
        {/* CALENDARIO MENSUAL COMPACTO - PROPUESTA 1 */}
        ...
        {/* SEMANAS ENERO - NUEVO DISEÑO PRINCIPAL */}
        <Semana1Enero birthday={birthday} />
        <EjerciciosSemana1Enero />
        <Semana2Enero birthday={birthday} />
        <EjerciciosSemana2Enero />
        <Semana3Enero birthday={birthday} />
        <Semana4Enero birthday={birthday} />
        <CierreEnero />

        {/* FEBRERO 2026 - MES DEL CUMPLEAÑOS */}
        <PaginaCumpleanos10Feb />
        <SemanaCumpleFebrero birthday={birthday} />
