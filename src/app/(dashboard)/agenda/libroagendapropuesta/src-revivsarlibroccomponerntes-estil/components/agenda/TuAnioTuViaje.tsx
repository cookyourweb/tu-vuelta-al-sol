...
export const CartaBienvenida = ({ name }: TuAnioTuViajeProps) => {
  ...
  return (
    <div className={`print-page bg-background p-12 flex flex-col ${config.pattern}`}>
      ...
      <div className={`space-y-6 text-foreground/80 leading-relaxed max-w-2xl mx-auto text-lg ${config.fontBody}`}>
        <p>
        ...
        <p>
          Cumples 51 años, y el Sol vuelve al mismo lugar donde estaba cuando llegaste al mundo.
        ...
        <p>
          Tu carta natal habla de una mujer intuitiva, sensible y profundamente perceptiva.
...
export const LoQuePideSoltar = () => {
  ...
  return (
    <div className={`print-page bg-background p-12 flex flex-col ${config.pattern}`}>
      ...
      <div className={`flex-1 flex flex-col justify-center max-w-2xl mx-auto w-full ${config.fontBody}`}>
        <p className="text-foreground/70 text-center mb-8 italic text-lg">
        ...
        <div className="space-y-6">
          <div className={`flex items-start gap-4 ${config.highlightPrimary} rounded-lg p-4`}>
            ...
            <span className="text-foreground/80">La necesidad de validación externa</span>
          </div>
          <div className={`flex items-start gap-4 ${config.highlightSecondary} rounded-lg p-4`}>
            <span className={`${config.iconSecondary} text-2xl`}>☽</span>
            <span className="text-foreground/80">La urgencia por demostrar</span>
          </div>
          <div className={`flex items-start gap-4 ${config.highlightAccent} rounded-lg p-4`}>
            <span className={`${config.iconSecondary} text-2xl`}>☽</span>
            <span className="text-foreground/80">El miedo a "no estar haciendo suficiente"</span>
          </div>
        </div>
