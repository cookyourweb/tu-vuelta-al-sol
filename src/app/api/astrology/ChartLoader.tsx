...
interface ChartData {
  houses: { id: number; name: string; degree: number }[]; // Replace with the actual structure of a house
  planets: { id: number; name: string; degree: number }[]; // Replace with the actual structure of a planet
  aspects: { id: number; type: string; planet1: string; planet2: string; degree: number }[];
  angles: { id: number; name: string; degree: number }[]; // Replace with the actual structure of an angle
  elementDistribution: { fire: number; earth: number; air: number; water: number }; // Explicitly define the structure
  modalityDistribution: { [key: string]: number }; // Replace with the actual structure if known
